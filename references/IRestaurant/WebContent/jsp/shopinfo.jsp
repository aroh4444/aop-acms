...
<%@ page language="java"
	import="com.seawind.dao.ShopDataDao,com.seawind.utils.OwnerUtil,com.seawind.webcommon.WebCommon"
...
<table width="<%=WebCommon.pageWidth%>" border="0" align="center">
	...
	<tr>
		...
		<table width="650px" border="1px" align="center">
			...
			<tr>
				<td width="280px" rowspan="5" align="center" valign="middle"><img
					src="<%=sd.getImgUrl()%>"
					width="280px" height="280px" style="text-align: center" align="middle"/></td>
