...
<%@ page language="java"
	import="com.seawind.dao.CookDataDao,com.seawind.model.CookData,com.seawind.utils.OwnerUtil,com.seawind.common.TAG,com.seawind.webcommon.WebCommon"
		...
		<table width="650px" border="1px" align="center">
			...
			<tr>
				...
				<td class="shopInfo" style="text-align: center;width: 120px"><a
					href="<%=request.getContextPath()%>/jsp/order.jsp?id=<%=cd.getId()%>">订购</a>
				</td>
			</tr>
